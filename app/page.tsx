      ...
      <main className="min-h-screen bg-background px-6 py-16 text-on-surface">
        <div className="editorial-shadow mx-auto max-w-xl rounded-xl border border-outline bg-surface p-8">
          ...
          <p className="mt-3 text-on-surface-variant">
            Manrope, palette tokens, Material Symbols, editorial shadow, and gold gradient
            utilities are wired in{" "}
            <code className="rounded bg-outline/60 px-1 text-sm">app/globals.css</code> and{" "}
            <code className="rounded bg-outline/60 px-1 text-sm">tailwind.config.ts</code>.
          </p>
